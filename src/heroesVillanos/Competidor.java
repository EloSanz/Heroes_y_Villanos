...
public abstract class Competidor {
        ...
        switch (caracteristica) {
            case VELOCIDAD:
                if (this.getCaracteristica(Caracteristica.VELOCIDAD) == competidor.getCaracteristica(Caracteristica.VELOCIDAD)) {
                    if (imprimirPorPantalla) System.out.println("Los competidores EMPATAN en VELOCIDAD");
                    ...
                    if (imprimirPorPantalla) System.out.println("El competidor " + this.getNombre() + " GANA en VELOCIDAD a " + competidor.getNombre());
                    return 1;
                } else {
                    if (imprimirPorPantalla) System.out.println("El competidor " + competidor.getNombre() + " GANA en VELOCIDAD a " + this.getNombre());
                    return 2;
                }
            case FUERZA:
                if (this.getCaracteristica(Caracteristica.FUERZA) == competidor.getCaracteristica(Caracteristica.FUERZA)) {
                    if (imprimirPorPantalla) System.out.println("Los competidores EMPATAN en FUERZA");
                    ...
                    if (imprimirPorPantalla) System.out.println("El competidor " + this.getNombre() + " GANA en FUERZA a " + competidor.getNombre());
                    return 1;
                } else {
                    if (imprimirPorPantalla) System.out.println("El competidor " + competidor.getNombre() + " GANA en FUERZA a " + this.getNombre());
                    return 2;
                }
            case RESISTENCIA:
                if (this.getCaracteristica(Caracteristica.RESISTENCIA) == competidor.getCaracteristica(Caracteristica.RESISTENCIA)) {
                    if (imprimirPorPantalla) System.out.println("Los competidores EMPATAN en RESISTENCIA");
                    ...
                    if (imprimirPorPantalla) System.out.println("El competidor " + this.getNombre() + " GANA en RESISTENCIA a " + competidor.getNombre());
                    return 1;
                } else {
                    if (imprimirPorPantalla) System.out.println("El competidor " + competidor.getNombre() + " GANA en RESISTENCIA a " + this.getNombre());
                    return 2;
                }
            case DESTREZA:
                if (this.getCaracteristica(Caracteristica.DESTREZA) == competidor.getCaracteristica(Caracteristica.DESTREZA)) {
                    if (imprimirPorPantalla) System.out.println("Los competidores EMPATAN en DESTREZA");
                    ...
                    if (imprimirPorPantalla) System.out.println("El competidor " + this.getNombre() + " GANA en DESTREZA a " + competidor.getNombre());
                    return 1;
                } else {
                    if (imprimirPorPantalla) System.out.println("El competidor " + competidor.getNombre() + " GANA en DESTREZA a " + this.getNombre());
                    return 2;
                }
            default:
    ...
    public int esGanador(Competidor competidor, Caracteristica caracteristica, boolean imprimirPorPantalla) throws CaracteristicaInexistenteException { // FUNCION ENVOLTORIO
        int contador = 0;
